...
impl VmHandle {
    pub(crate) fn new(client: Client, vm_id: Uuid) -> Self {
        Self {
            client,
            vm_id,
            linux_username: None,
    ...
    pub async fn exec(
        ...
        self.client.exec_await(&self.vm_id_str(), &body).await
    }
    ...
    pub async fn info(
        ...
        self.client.get_vm(&self.vm_id_str()).await
    }
    ...
    pub async fn start(&self) -> Result<ResponseValue<types::StartedVmResponse>, Error<()>> {
        ...
        self.client.start_vm(&self.vm_id_str(), &body).await
    }
    ...
    pub async fn stop(
        ...
        self.client.stop_vm(&self.vm_id_str()).await
    }
    ...
    pub async fn kill(
        ...
        self.client.kill_vm(&self.vm_id_str()).await
    }
    ...
    pub async fn suspend(
        ...
        self.client.suspend_vm(&self.vm_id_str()).await
    }
    ...
    pub async fn wait_for_exit(
        ...
        self.client.wait_vm(&self.vm_id_str()).await
    }
    ...
    pub async fn snapshot(&self) -> Result<ResponseValue<types::SnapshotVmResponse>, Error<()>> {
        ...
        self.client.snapshot_vm(&self.vm_id_str(), &body).await
    }
    ...
    pub async fn fork(
        ...
        self.client.fork_vm(&self.vm_id_str(), &body).await
    }
    ...
    pub async fn optimize(
        ...
        self.client.optimize_vm(&self.vm_id_str()).await
    }
    ...
    pub async fn delete(
        ...
        self.client.delete_vm(&self.vm_id_str()).await
    }
